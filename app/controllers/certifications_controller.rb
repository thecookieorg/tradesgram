class CertificationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @certification.save
        ...
        format.html { redirect_to root_path, notice: 'Certification was successfully created.' }
  ...
  private
    ...
    def certification_params
      params.require(:certification).permit(:certification_name, :certification_authority, :license_number, :certification_url, :this_certificate_does_not_expire)
    end
end
